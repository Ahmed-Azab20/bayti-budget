...
let app: FirebaseApp | null = null; let firestore: Firestore | null = null;
...
export function configureFirebase(config: FirebaseSettings) { app = getApps()[0] || initializeApp(config); firestore = getFirestore(app); return firestore; }
